...
class TestEntranceSoftDeleteView:
    ...
    def test_delete_entrance_today_with_no_other_valid_entrances(self, logged_in_client):
        """
...
class TestEntranceCreateView:
    ...
    def test_create_entrance_for_existing_citizen_updates_phone(self, logged_in_client):
        ...
        assert Entrance.objects.filter(citizen=existing_citizen, department=department).exists()

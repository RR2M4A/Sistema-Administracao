...
const radio_admin_true = document.querySelector('input[name="is-admin"][value="true"]');
const radio_admin_false = document.querySelector('input[name="is-admin"][value="false"]');
const radio_blocked_true = document.querySelector('input[name="is-blocked"][value="true"]');
...
async function load_popup(user_info) {
    ...
    if (user_info.is_admin == "true") {
        radio_admin_true.checked = true;
    } else {
        radio_admin_false.checked = true;
    }

    if (user_info.is_blocked == "true") {
        radio_blocked_true.checked = true;
    } else {
